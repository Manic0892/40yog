//CURRENTLY UNUSED.  This is just the basic player that actually works and which you'd want in most levels for testing.

ig.module(
	'game.entities.gunPlayer'
).requires(
	'game.entities.player'
).defines(function() {
	EntityGunPlayer = EntityPlayer.extend({
